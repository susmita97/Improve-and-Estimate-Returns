...
def app():
    ...
    if submit_button and range2>range1:
        ...
        permitted_range={'TOTAL UNITS': [1, 60], 'COMMERCIAL UNITS': [1, 60], 'RESIDENTIAL UNITS': [1, 60],'LAND SQUARE FEET': [3000,10000],'GROSS SQUARE FEET': [4000,10000],'PROPERTY AGE': [120, 200]})
